...
const long = ["Traditional Investments", "SIP"];
...
const prefer = ["SIP", "Traditional Investments"];
  ...
  try {
    ...
    await axios.post(url, data, {
      headers: {
        ...
        "Referer":
        "https://docs.google.com/forms/d/e/1FAIpQLSeMBZiwJZ2ssJo4A0IhfJxTVmlCzQuDikYerys6ASuxJRh0gQ/viewform"
      }
    });
    ...
    console.log(`failed ${i}`, err.response?.status);
  }
}
